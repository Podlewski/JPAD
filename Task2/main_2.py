...
print_statistics(columns_no_nans, "No missing values")
print_statistics(columns_filled, "Filled missing values")
...
print_regression_statistics(columns_no_nans, "header", no_nans_filename, show_plot=args.show_plot)
print_regression_statistics(columns_filled, "header", filled_filename, show_plot=args.show_plot)
